...
export const autoGeneratedPrefix = '@@';
export enum AutoGeneratedSignatures {
    Input = 'input',
    Output = 'output',
    Combine = 'combine',
    Separate = 'separate',
}
export function createAutoGeneratedId(name: AutoGeneratedSignatures, ...rest: string[]) {
    return autoGeneratedPrefix + [ name, ...rest ].join('_');
}
