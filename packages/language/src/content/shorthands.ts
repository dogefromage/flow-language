...
// interface VarRowOptions extends ArgumentSignature {
//     defaultValue: T;
//     defaultDestructure: boolean;
// }

// const varRow = {
//     string: (id: string, ops?: Partial<VarRowOptions<string>>): ArgumentSignature => ({
//         id,
//         exprType: 'initializer',
//         specifier: createAliasType('string'),
//         ...ops,
//     }),
//     number: (id: string, ops?: Partial<VarRowOptions<number>>): ArgumentRowState => ({
//         id,
//         rowType: 'input-variable',
//         specifier: createAliasType('number'),
//         ...ops,
//     }),
//     boolean: (id: string, ops?: Partial<VarRowOptions<boolean>>): ArgumentRowState => ({
//         id,
//         rowType: 'input-variable',
